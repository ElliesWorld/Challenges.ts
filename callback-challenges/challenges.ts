...
// EASIEST WAY: const map = (array:number[],addTwo: addTwoFunctionType)=>{
// return array.map(addTwo);}

//Print the result of calling the map function with the array 1,2,3 and addTwo function
